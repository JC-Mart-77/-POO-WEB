...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2017 a las 10:03:31
...
CREATE TABLE IF NOT EXISTS `tbl_noticias` (
  ...
  `Foto_Noticia` varchar(200) NOT NULL,
...
(1, 1, 1, 1, 1, 'juan', 'linux.jpg', 'linux el mejor SO', 'linux es un sistema operativo muy bueno', '2017-11-01', 'flipear'),
(2, 1, 1, 1, 1, 'juan', 'Alfa-es-la-primera-letra-del-alfabeto-griego1.png', 'hola', 'hola', '0000-00-00', '1'),
(3, 1, 1, 1, 1, 'juan', 'linux.jpg', 'hola', 'hola', '0000-00-00', '1'),
(4, 1, 1, 1, 1, 'juan', 'Alfa-es-la-primera-letra-del-alfabeto-griego1.png', 's', 'd', '0000-00-00', '1'),
(5, 1, 1, 1, 1, 'juan', 'Alfa-es-la-primera-letra-del-alfabeto-griego1.png', 'f', 'f', '0000-00-00', '1'),
(6, 1, 1, 1, 1, 'juan', 'Alfa-es-la-primera-letra-del-alfabeto-griego1.png', 's', 's', '0000-00-00', '1'),
(7, 1, 1, 1, 1, 'juan', 'Alfa-es-la-primera-letra-del-alfabeto-griego1.png', 's', 's', '0000-00-00', '1'),
(8, 1, 1, 1, 1, 'juan', 'Alfa-es-la-primera-letra-del-alfabeto-griego1.png', 'ggg', 'gggg', '0000-00-00', '1'),
(9, 1, 1, 1, 1, 'juan', 'Alfa-es-la-primera-letra-del-alfabeto-griego1.png', 's', 's', '0000-00-00', '1');
